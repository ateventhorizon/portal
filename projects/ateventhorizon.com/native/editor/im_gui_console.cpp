...
struct ExampleAppConsole {
    ...
    ExampleAppConsole() {
        ...
        HistoryPos = -1;
        Commands.push_back( "rr.changeTime(" );
        AutoScroll = true;
    ...
    void Draw( const char *title, bool *p_open, RenderOrchestrator& rsg ) {
        ...
        ImGui::PushItemWidth(getScreenSizei.x());
    ...
    void ExecCommand( const char *command_line, RenderOrchestrator& rsg ) {
        AddLog( "# %s\n", command_line );
        ...
        // Process command
        rsg.setLuaScriptHotReload( command_line );
...
void ImGuiLuaConsole( RenderOrchestrator& rsg ) {
    static ExampleAppConsole console;
    static bool isOpen = true;
    console.Draw( "Lua Console", &isOpen, rsg );
}
